...
export default function Hero({ dict, lang }: Props) {
  return (
    <section className="mx-auto max-w-[1400px] px-4 pt-8 pb-8 sm:px-6 lg:px-10 lg:pt-12 lg:pb-12">
      <p className="text-sm tracking-[0.14em] text-muted uppercase">
        {dict.home.slogan}
      </p>

      <div className="mt-4 grid gap-5 lg:grid-cols-2 lg:items-end lg:gap-12">
        <h1 className="max-w-[16ch] text-3xl tracking-tight text-balance sm:text-4xl lg:text-5xl">
          {dict.home.title}
        </h1>

        <div className="lg:pb-2">
          <p className="max-w-prose text-base text-muted sm:text-lg lg:text-xl">{dict.home.lead}</p>
