...
/*
  ...
  Место не заполняли ничем взамен: пустое поле честнее графика ни о чём.
...
export default function Hero({ dict, lang }: Props) {
  return (
    <section className="mx-auto max-w-[1400px] px-4 pt-14 pb-14 sm:px-6 lg:px-10 lg:pt-24 lg:pb-20">
      ...
      <h1 className="mt-6 max-w-[16ch] text-3xl tracking-tight text-balance sm:text-4xl lg:text-5xl">
        {dict.home.title}
      </h1>

      <p className="mt-8 max-w-prose text-lg text-muted lg:text-xl">
        {dict.home.lead}
      </p>
