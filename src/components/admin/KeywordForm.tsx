...
export default function KeywordForm({ lang }: { lang: NewsLang }) {
  ...
  return (
    <form action={run}>
      ...
      {/* Правило отбора стоит здесь, а не в общей рамке наверху: его надо
          знать в ту секунду, когда набираешь слово. */}
      <p className="note">
        Сравнение с начала слова, окончание любое: «мошенничеств» поймает и
        «мошенничество», и «мошенничества».
      </p>
      <p>
