...
export type MlVerdict = {
  ...
  /*
    ...
    confidence здесь — ВЕРОЯТНОСТЬ НАРУШЕНИЯ этого вида, а не уверенность
    модели в своём ответе. Разница не тонкая: «neutral 0.98» означает «на
    98% уверен, что этого нет», и в старом виде показывалось человеку как
    98% рядом с названием вида — то есть читалось ровно наоборот.
  */
