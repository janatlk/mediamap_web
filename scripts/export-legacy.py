...
# Виды нарушений: только опознание и порядок. Названия, описания и правовая
# основа лежат в словаре сайта (src/lib/i18n/violations-*.ts) — держать
# половину текста здесь, а половину там значит однажды их развести.
TARGET_TYPES = [
    {"slug": "hate-speech", "sort": 1},
    {"slug": "disinformation", "sort": 2},
    {"slug": "digital-fraud", "sort": 3},
]

# Прежняя база знала четыре вида. «Пропаганда» уходит в дезинформацию:
# односторонняя подача ради нужного вывода — её частный случай. «Другое»
# в данных не встречается ни разу, переносить оттуда нечего.
LEGACY_TO_SLUG = {
