...
PAIRS = [
    ...
    ("hate",       "surface", 4.5, "категория: язык вражды"),
    ("disinfo",    "surface", 4.5, "категория: дезинформация"),
    ("propaganda", "surface", 4.5, "категория: пропаганда"),
    ("other",      "surface", 4.5, "категория: другое"),
